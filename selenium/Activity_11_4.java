...
public class Activity_11_4 {
	        ...
	        String newTabText = driver.findElement(By.xpath("//div/div/div[1]/div/div[@class=\"sub header\"]")).getText();
	        ...
	        //Get heading on new page
	        newTabText = driver.findElement(By.xpath("//div/div/div/div/div[@class=\"sub header\"]")).getText();
	        System.out.println("New tab heading is: " + newTabText);
