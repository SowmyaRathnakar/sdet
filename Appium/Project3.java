...
public class Project3 {
    ...
    public void addNote() throws Throwable {
    	...
    	//adding title
    	driver.findElementById("editable_title").sendKeys("First Reminder");
    	//adding note description
    	Thread.sleep(5000);
    	driver.findElementById("edit_note_text").sendKeys("Task added into Google Keep app, Reminder section1");
